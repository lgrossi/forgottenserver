...
enum OperatingSystem_t : uint8_t
{
	...
	CLIENTOS_MOBA_LINUX = 20,
	CLIENTOS_MOBA_WINDOWS = 21,
	CLIENTOS_MOBA_MAC = 22,
};
...
enum SpecialSkills_t
{
	...
	SPECIALSKILL_MAGIC_CRITICALHITCHANCE,
	SPECIALSKILL_MAGIC_CRITICALHITAMOUNT,

	SPECIALSKILL_FIRST = SPECIALSKILL_CRITICALHITCHANCE,
	SPECIALSKILL_LAST = SPECIALSKILL_MAGIC_CRITICALHITAMOUNT
};
...
struct MarketOfferEx
{
	...
	MarketOfferEx(MarketOfferEx &&other) : id(other.id), playerId(other.playerId), timestamp(other.timestamp), price(other.price),
