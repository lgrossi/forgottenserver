...
public:
	Condition() = default;
	Condition(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false, uint32_t subId = 0) : endTime(ticks == -1 ? std::numeric_limits<int64_t>::max() : 0),
...
{
public:
	ConditionGeneric(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false, uint32_t subId = 0) : Condition(id, type, ticks, buff, subId) {}
...
{
public:
	ConditionAttributes(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false, uint32_t subId = 0) : ConditionGeneric(id, type, ticks, buff, subId) {}
...
{
public:
	ConditionRegeneration(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false, uint32_t subId = 0) : ConditionGeneric(id, type, ticks, buff, subId) {}
...
{
public:
	ConditionSoul(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false, uint32_t subId = 0) : ConditionGeneric(id, type, ticks, buff, subId) {}
...
{
public:
	ConditionInvisible(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false, uint32_t subId = 0) : ConditionGeneric(id, type, ticks, buff, subId) {}
...
public:
	...
	ConditionDamage(ConditionId_t id, ConditionType_t type, bool buff = false, uint32_t subId = 0) : Condition(id, type, 0, buff, subId) {}
...
{
public:
	ConditionSpeed(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff, uint32_t subId, int32_t changeSpeed) : Condition(id, type, ticks, buff, subId), speedDelta(changeSpeed) {}
...
{
public:
	ConditionOutfit(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false, uint32_t subId = 0) : Condition(id, type, ticks, buff, subId) {}
...
{
public:
	ConditionLight(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff, uint32_t subId, uint8_t lightlevel, uint8_t lightcolor) : Condition(id, type, ticks, buff, subId), lightInfo(lightlevel, lightcolor) {}
...
{
public:
	ConditionSpellCooldown(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false, uint32_t subId = 0) : ConditionGeneric(id, type, ticks, buff, subId) {}
...
{
public:
	ConditionSpellGroupCooldown(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false, uint32_t subId = 0) : ConditionGeneric(id, type, ticks, buff, subId) {}
