...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(CONDITION_PARAM_SPECIALSKILL_MAGIC_CRITICALHITCHANCE)
	registerEnum(CONDITION_PARAM_SPECIALSKILL_MAGIC_CRITICALHITAMOUNT)
	...
	registerEnum(CLIENTOS_MOBA_LINUX)
	registerEnum(CLIENTOS_MOBA_WINDOWS)
	registerEnum(CLIENTOS_MOBA_MAC)
	...
	registerEnum(SPECIALSKILL_MAGIC_CRITICALHITCHANCE)
	registerEnum(SPECIALSKILL_MAGIC_CRITICALHITAMOUNT)
